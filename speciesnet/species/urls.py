...
urlpatterns = [
    ...
    path(
        "species/<str:pk>/collection-locations/add/",
        views.createSpeciesCollectionLocation,
        name="createSpeciesCollectionLocation",
    ),
    path(
        "species/collection-location/<str:pk>/edit/",
        views.editSpeciesCollectionLocation,
        name="editSpeciesCollectionLocation",
    ),
    path(
        "species/collection-location/<str:pk>/delete/",
        views.deleteSpeciesCollectionLocation,
        name="deleteSpeciesCollectionLocation",
    ),
    ### CARES ASN or Shared ###
    path("cares_overview/", views.cares_overview, name="cares_overview"),
    path(
        "caresLiaisonDashboard/<str:pk>/",
        views.AquaristClubCaresLiaisonListView.as_view(),
        name="caresLiaisonDashboard",
    ),
    path(
        "registerCaresSpeciesInstance/<str:pk>/",
        views.registerCaresSpeciesInstance,
        name="registerCaresSpeciesInstance",
    ),
    ...
    path(
        "caresRegistrationNotifyAquarist/<int:pk>/",
        views.caresRegistrationNotifyAquarist,
        name="caresRegistrationNotifyAquarist",
    ),
    ...
    path(
        "cares/importCaresLegacyRegistrations/",
        views.importCaresLegacyRegistrations,
        name="importCaresLegacyRegistrations",
    ),
    path(
        "registerCaresSpecies/<str:pk>/", views.registerCaresSpecies, name="registerCaresSpecies"
    ),  # annonymous user registration
    path(
        "registerCaresSelectSpecies/", views.registerCaresSelectSpecies, name="registerCaresSelectSpecies"
    ),  # annonymous user registration
    ...
    path(
        "raffle/mark-winner/<str:species_name>/<str:email>/",
        views.raffle_mark_manual_winner,
        name="raffle_mark_manual_winner",
    ),
    path(
        "raffle/mark-account-created/<str:email>/",
        views.raffle_mark_account_created,
        name="raffle_mark_account_created",
    ),
    path("raffle/export_entries/", views.raffle_export_entries, name="raffle_export_entries"),
    path(
        "raffle-admin/export-species-results/",
        views.raffle_export_species_results,
        name="raffle_export_species_results",
    ),
    ...
    path(
        "chooseSpeciesInstancesForLabels/<str:pk>/",
        views.chooseSpeciesInstancesForLabels,
        name="chooseSpeciesInstancesForLabels",
    ),
    ...
    path(
        "createSpeciesInstanceLogEntry/<str:pk>/",
        views.createSpeciesInstanceLogEntry,
        name="createSpeciesInstanceLogEntry",
    ),
    path(
        "editSpeciesInstanceLogEntry/<str:pk>/", views.editSpeciesInstanceLogEntry, name="editSpeciesInstanceLogEntry"
    ),
    path(
        "deleteSpeciesInstanceLogEntry/<str:pk>/",
        views.deleteSpeciesInstanceLogEntry,
        name="deleteSpeciesInstanceLogEntry",
    ),
    ...
    path(
        "createSpeciesMaintenanceLog/<str:pk>/", views.createSpeciesMaintenanceLog, name="createSpeciesMaintenanceLog"
    ),
    path("editSpeciesMaintenanceLog/<str:pk>/", views.editSpeciesMaintenanceLog, name="editSpeciesMaintenanceLog"),
    path(
        "addMaintenanceGroupCollaborator/<str:pk>/",
        views.addMaintenanceGroupCollaborator,
        name="addMaintenanceGroupCollaborator",
    ),
    path(
        "removeMaintenanceGroupCollaborator/<str:pk>/",
        views.removeMaintenanceGroupCollaborator,
        name="removeMaintenanceGroupCollaborator",
    ),
    path("addMaintenanceGroupSpecies/<str:pk>/", views.addMaintenanceGroupSpecies, name="addMaintenanceGroupSpecies"),
    path(
        "removeMaintenanceGroupSpecies/<str:pk>/",
        views.removeMaintenanceGroupSpecies,
        name="removeMaintenanceGroupSpecies",
    ),
    path(
        "deleteSpeciesMaintenanceLog/<str:pk>/", views.deleteSpeciesMaintenanceLog, name="deleteSpeciesMaintenanceLog"
    ),
    path(
        "createSpeciesMaintenanceLogEntry/<str:pk>/",
        views.createSpeciesMaintenanceLogEntry,
        name="createSpeciesMaintenanceLogEntry",
    ),
    path(
        "editSpeciesMaintenanceLogEntry/<str:pk>/",
        views.editSpeciesMaintenanceLogEntry,
        name="editSpeciesMaintenanceLogEntry",
    ),
    path(
        "deleteSpeciesMaintenanceLogEntry/<str:pk>/",
        views.deleteSpeciesMaintenanceLogEntry,
        name="deleteSpeciesMaintenanceLogEntry",
    ),
    ...
    path(
        "tools/enforceSpeciesNameSingleQuotes/",
        views.enforceSpeciesNameSingleQuotes,
        name="enforceSpeciesNameSingleQuotes",
    ),
    ...
    path(
        "species/import/importArchiveResults/<str:pk>/", views.importArchiveResults, name="importArchiveResults"
    ),  # admin-only
    path("collectSpeciesData/", views.collectSpeciesData, name="collectSpeciesData"),  # admin-only
    path(
        "export-species-collection-locations/",
        views.exportSpeciesCollectionLocations,
        name="exportSpeciesCollectionLocations",
    ),
    path(
        "import-species-collection-locations/",
        views.importSpeciesCollectionLocations,
        name="importSpeciesCollectionLocations",
    ),
    path(
        "import-species-instance-collection-locations/",
        views.importSpeciesInstanceCollectionLocations,
        name="importSpeciesInstanceCollectionLocations",
    ),
    path(
        "species-manage-collection-locations/",
        views.speciesWithManageCollectionLocations,
        name="speciesWithManageCollectionLocations",
    ),
    ...
    path(
        "speciesImportReviewDetail/<str:staging_id>/", views.reviewSpeciesImportDetail, name="reviewSpeciesImportDetail"
    ),
    ...
    path(
        "tools/species-feedback/<int:pk>/apply-photo/",
        views.applySpeciesFeedbackPhoto,
        name="applySpeciesFeedbackPhoto",
    ),
