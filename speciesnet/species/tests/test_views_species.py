...
from species.models import Species, SpeciesComment, SpeciesInstance, SpeciesReferenceLink
...
class SpeciesCreateViewTest(TestCase):
    ...
    def setUp(self):
        ...
        self.other_user = User.objects.create_user(username="otheruser", email="other@test.com", password="testpass123")
        self.client = Client()
    ...
    def test_create_duplicate_species_redirects_to_existing(self):
        ...
        existing = Species.objects.create(
            name="Melanochromis auratus", category="CIC", global_region="AFR", created_by=self.other_user
        )
...
class SpeciesEditViewTests(TestCase):
    ...
    def setUp(self):
        ...
        self.regular_user = User.objects.create_user(email="user@test.com", username="testuser", password="testpass123")
...
class SpeciesDeleteViewTests(TestCase):
    ...
    def setUp(self):
        ...
        self.deletable_species = Species.objects.create(name="Deletable Species", category="CIC", global_region="AFR")
        ...
        self.protected_species = Species.objects.create(name="Protected Species", category="CIC", global_region="AFR")
        ...
        SpeciesInstance.objects.create(name="Test Instance", user=self.regular_user, species=self.protected_species)
    ...
    def test_delete_species_admin_can_delete(self):
        ...
        test_species = Species.objects.create(name="Admin Deletable Species", category="CIC", global_region="AFR")
        from datetime import timedelta
...
class AdminStaffPermissionComparisonTests(TestCase):
    ...
    def setUp(self):
        ...
        self.admin_only = User.objects.create_user(
            email="admin@test.com", username="adminonly", password="testpass123", is_admin=True, is_staff=False
        )
        self.staff_only = User.objects.create_user(
            email="staff@test.com", username="staffonly", password="testpass123", is_admin=False, is_staff=True
        )

        self.old_species = Species.objects.create(name="Test Species", category="CIC", global_region="AFR")
        from datetime import timedelta
    ...
    def test_admin_and_staff_have_same_edit_permissions(self):
        ...
        self.assertEqual(
            staff_can_edit,
            admin_can_edit,
            "is_admin and is_staff should have equivalent permissions for Species editing",
        )
    ...
    def test_admin_and_staff_have_same_delete_permissions(self):
        ...
        self.assertEqual(
            staff_can_delete,
            admin_can_delete,
            "is_admin and is_staff should have equivalent permissions for Species deletion",
        )
...
class SpeciesCommentEditViewTest(TestCase):
    ...
    def setUp(self):
        ...
        self.other_user = User.objects.create_user(username="otheruser", email="other@test.com", password="testpass123")
        self.admin_user = User.objects.create_user(
            username="adminuser", email="admin@test.com", password="testpass123", is_staff=True, is_admin=True
        )

        self.species = Species.objects.create(
            name="Melanochromis auratus", category="CIC", global_region="AFR", created_by=self.user
        )
    ...
    def test_edit_comment_with_valid_data(self):
        ...
        response = self.client.post(
            reverse("editSpeciesComment", args=[self.comment.id]),
            {
    ...
    def test_edit_comment_preserves_species(self):
        ...
        Species.objects.create(name="Other Species", category="CIC", global_region="AFR", created_by=self.user)
...
class SpeciesReferenceLinkCreateViewTest(TestCase):
    ...
    def test_create_reference_link_with_valid_data(self):
        ...
        response = self.client.post(
            reverse("createSpeciesReferenceLink", args=[self.species.id]),
            {
...
class SpeciesReferenceLinkEditViewTest(TestCase):
    ...
    def setUp(self):
        ...
        self.link = SpeciesReferenceLink.objects.create(
            name="Original Link", user=self.user, species=self.species, reference_url="https://original.com"
        )
    ...
    def test_edit_reference_link_with_valid_data(self):
        ...
        response = self.client.post(
            reverse("editSpeciesReferenceLink", args=[self.link.id]),
            {
...
class SpeciesReferenceLinkDeleteViewTest(TestCase):
    ...
    def setUp(self):
        ...
        self.link = SpeciesReferenceLink.objects.create(
            name="Test Link", user=self.user, species=self.species, reference_url="https://test.com"
        )
