...
class UserModelCRUDTest(MinimalTestCase):
    ...
    def setUp(self):
        ...
        self.user_data = {"email": "test@example.com", "username": "testuser", "password": "testpass123"}
    ...
    def test_user_email_unique(self):
        ...
        with self.assertRaises(IntegrityError):
            User.objects.create_user(email="test@example.com", username="different", password="pass")

    def test_user_username_unique(self):
        """Test username uniqueness constraint."""
        User.objects.create_user(**self.user_data)
        with self.assertRaises(IntegrityError):
            User.objects.create_user(email="different@example.com", username="testuser", password="pass")
...
class UserModelMethodsTest(MinimalTestCase):
    ...
    def setUp(self):
        ...
        self.user = User.objects.create_user(email="methods@example.com", username="methoduser", password="pass123")

    def test_get_display_name_with_email_username(self):
        """Test get_display_name strips email domain."""
        user = User.objects.create_user(email="test@example.com", username="john@domain.com", password="pass")
...
class SpeciesModelCRUDTest(BaseTestCase):
    ...
    def test_update_species(self):
        ...
        species = Species.objects.create(name="Test Species", created_by=self.basic_user)
    ...
    def test_delete_species(self):
        ...
        species = Species.objects.create(name="Temporary Species", created_by=self.basic_user)
    ...
    def test_species_default_values(self):
        ...
        species = Species.objects.create(name="Default Test", created_by=self.basic_user)
    ...
    def test_species_category_choices(self):
        ...
        for cat in categories:
            species = Species.objects.create(name=f"Test Species {cat}", category=cat, created_by=self.basic_user)
    ...
    def test_species_global_region_choices(self):
        ...
        for region in regions:
            species = Species.objects.create(
                name=f"Test Species {region}", global_region=region, created_by=self.basic_user
            )
    ...
    def test_species_cares_classification_choices(self):
        ...
        for status in statuses:
            species = Species.objects.create(
                name=f"Test Species {status}", cares_classification=status, created_by=self.basic_user
            )
...
class SpeciesModelMethodsTest(BaseTestCase):
    ...
    def test_genus_name_with_leading_space(self):
        ...
        species = Species.objects.create(name="  Melanochromis auratus", created_by=self.basic_user)
    ...
    def test_species_created_by_deletion(self):
        ...
        temp_user = User.objects.create_user(email="temp@example.com", username="temp", password="pass")
        species = Species.objects.create(name="Temp Species", created_by=temp_user)
        temp_user.delete()
...
class SpeciesInstanceModelCRUDTest(BaseTestCase):
    ...
    def test_create_species_instance(self):
        ...
        instance = SpeciesInstance.objects.create(name="My Fish Colony", user=self.basic_user, species=self.cichlid)
    ...
    def test_update_species_instance(self):
        ...
        instance = SpeciesInstance.objects.create(name="Test Colony", user=self.basic_user, species=self.cichlid)
    ...
    def test_delete_species_instance(self):
        ...
        instance = SpeciesInstance.objects.create(name="Temp Instance", user=self.basic_user, species=self.cichlid)
    ...
    def test_species_instance_default_values(self):
        """Test default field values."""
        instance = SpeciesInstance.objects.create(name="Default Test", user=self.basic_user, species=self.cichlid)
    ...
    def test_species_instance_genetic_line_choices(self):
        ...
        for line in genetic_lines:
            instance = SpeciesInstance.objects.create(
                name=f"Instance {line}", user=self.basic_user, species=self.cichlid, genetic_traits=line
            )
    ...
    def test_species_instance_cascade_on_user_delete(self):
        ...
        temp_user = User.objects.create_user(email="temp2@example.com", username="temp2", password="pass")
        instance = SpeciesInstance.objects.create(name="Temp Instance", user=temp_user, species=self.cichlid)
        instance_id = instance.id
        temp_user.delete()
        self.assertEqual(SpeciesInstance.objects.filter(id=instance_id).count(), 0)
    ...
    def test_species_instance_protect_on_species_delete(self):
        ...
        species = Species.objects.create(name="Protected Species", created_by=self.basic_user)
        SpeciesInstance.objects.create(name="Protecting Instance", user=self.basic_user, species=species)
        with self.assertRaises(ProtectedError):
            species.delete()

    def test_species_instance_str_method(self):
        """Test __str__ method."""
        instance = SpeciesInstance.objects.create(name="My Colony", user=self.basic_user, species=self.cichlid)
    ...
    def test_species_instance_ordering(self):
        ...
        SpeciesInstance.objects.create(name="First", user=self.basic_user, species=self.cichlid)
        SpeciesInstance.objects.create(name="Second", user=self.basic_user, species=self.cichlid)
        SpeciesInstance.objects.create(name="Third", user=self.basic_user, species=self.cichlid)
...
class SpeciesCommentModelTest(BaseTestCase):
    ...
    def test_species_comment_cascade_on_user_delete(self):
        ...
        temp_user = User.objects.create_user(email="commenter@example.com", username="commenter", password="pass")
        comment = SpeciesComment.objects.create(name="Comment", user=temp_user, species=self.cichlid, comment="Test")
    ...
    def test_species_comment_cascade_on_species_delete(self):
        ...
        species = Species.objects.create(name="Temp Species", created_by=self.basic_user)
        comment = SpeciesComment.objects.create(name="Comment", user=self.basic_user, species=species, comment="Test")
        comment_id = comment.id
        species.delete()
        self.assertEqual(SpeciesComment.objects.filter(id=comment_id).count(), 0)
    ...
    def test_species_comment_ordering(self):
        ...
        SpeciesComment.objects.create(name="First", user=self.basic_user, species=self.cichlid, comment="First comment")
        SpeciesComment.objects.create(
            name="Second", user=self.basic_user, species=self.cichlid, comment="Second comment"
        )
    ...
    def test_species_comment_str_method(self):
        """Test __str__ method."""
        comment = SpeciesComment.objects.create(
            name="Test Comment", user=self.basic_user, species=self.cichlid, comment="Comment text"
        )
...
class SpeciesReferenceLinkModelTest(BaseTestCase):
    ...
    def test_reference_link_cascade_on_user_delete(self):
        ...
        temp_user = User.objects.create_user(email="linker@example.com", username="linker", password="pass")
        link = SpeciesReferenceLink.objects.create(
            name="Link", user=temp_user, species=self.cichlid, reference_url="https://example.com"
        )
        link_id = link.id
        temp_user.delete()
    ...
    def test_reference_link_str_method(self):
        """Test __str__ method."""
        link = SpeciesReferenceLink.objects.create(
            name="Reference", user=self.basic_user, species=self.cichlid, reference_url="https://example.com"
        )
...
class AquaristClubModelTest(BaseTestCase):
    ...
    def test_club_default_values(self):
        """Test default field values."""
        club = AquaristClub.objects.create(name="Default Club", website="https://example.com")
    ...
    def test_club_bap_points_validation(self):
        ...
        club = AquaristClub.objects.create(name="Points Club", website="https://example.com", bap_default_points=50)
...
class AquaristClubMemberModelTest(BaseTestCase):
    ...
    def test_create_club_member(self):
        ...
        member = AquaristClubMember.objects.create(name="Member Record", club=self.basic_club, user=self.basic_user)
    ...
    def test_club_member_default_values(self):
        """Test default field values."""
        member = AquaristClubMember.objects.create(name="Member", club=self.basic_club, user=self.basic_user)
    ...
    def test_club_member_cascade_on_club_delete(self):
        ...
        temp_club = AquaristClub.objects.create(name="Temp Club", website="https://temp.com")
        member = AquaristClubMember.objects.create(name="Member", club=temp_club, user=self.basic_user)
        member_id = member.id
        temp_club.delete()
    ...
    def test_club_member_cascade_on_user_delete(self):
        ...
        temp_user = User.objects.create_user(email="member@example.com", username="member", password="pass")
        member = AquaristClubMember.objects.create(name="Member", club=self.basic_club, user=temp_user)
        member_id = member.id
        temp_user.delete()
        self.assertEqual(AquaristClubMember.objects.filter(id=member_id).count(), 0)
...
class BapSubmissionModelTest(BaseTestCase):
    ...
    def setUp(self):
        ...
        self.instance = SpeciesInstance.objects.create(
            name="Breeding Colony", user=self.active_user, species=self.cichlid, have_spawned=True
        )
    ...
    def test_bap_submission_default_values(self):
        """Test default field values."""
        submission = BapSubmission.objects.create(name="BAP Entry", aquarist=self.active_user, club=self.basic_club)
    ...
    def test_bap_submission_status_choices(self):
        ...
        for status in statuses:
            submission = BapSubmission.objects.create(
                name=f"BAP {status}", aquarist=self.active_user, club=self.basic_club, status=status
            )
            self.assertEqual(submission.status, status)

    def test_bap_submission_str_method(self):
        """Test __str__ method."""
        submission = BapSubmission.objects.create(name="Test BAP", aquarist=self.active_user, club=self.basic_club)
...
class BapGenusModelTest(BaseTestCase):
    ...
    def test_create_bap_genus(self):
        ...
        genus = BapGenus.objects.create(
            name="Aulonocara", club=self.basic_club, points=15, example_species=self.cichlid
        )
    ...
    def test_bap_genus_default_values(self):
        """Test default field values."""
        genus = BapGenus.objects.create(name="TestGenus", club=self.basic_club)
    ...
    def test_bap_genus_str_method(self):
        """Test __str__ method."""
        genus = BapGenus.objects.create(name="Melanochromis", club=self.basic_club)
...
class BapSpeciesModelTest(BaseTestCase):
    ...
    def test_create_bap_species(self):
        ...
        bap_species = BapSpecies.objects.create(
            name="Special Points", species=self.cichlid, club=self.basic_club, points=25
        )
    ...
    def test_bap_species_cascade_on_species_delete(self):
        ...
        temp_species = Species.objects.create(name="Temp Species", created_by=self.basic_user)
        bap_species = BapSpecies.objects.create(name="Config", species=temp_species, club=self.basic_club)
    ...
    def test_bap_species_str_method(self):
        """Test __str__ method."""
        bap_species = BapSpecies.objects.create(name="Test Config", species=self.cichlid, club=self.basic_club)
...
class ImportArchiveModelTest(BaseTestCase):
    ...
    def test_create_import_archive(self):
        ...
        archive = ImportArchive.objects.create(
            name="Import 2025-01-15", aquarist=self.basic_user, import_csv_file="uploads/2025/01/15/data.csv"
        )
    ...
    def test_import_archive_default_values(self):
        """Test default field values."""
        archive = ImportArchive.objects.create(
            name="Import", aquarist=self.basic_user, import_csv_file="uploads/test.csv"
        )
    ...
    def test_import_archive_str_method(self):
        """Test __str__ method."""
        archive = ImportArchive.objects.create(
            name="Test Import", aquarist=self.basic_user, import_csv_file="uploads/test.csv"
        )
...
class RelationshipTest(BaseTestCase):
    ...
    def test_user_species_instances_relationship(self):
        ...
        instance1 = SpeciesInstance.objects.create(name="Instance 1", user=self.basic_user, species=self.cichlid)
        instance2 = SpeciesInstance.objects.create(name="Instance 2", user=self.basic_user, species=self.killifish)
    ...
    def test_species_instances_relationship(self):
        ...
        instance1 = SpeciesInstance.objects.create(name="Instance 1", user=self.basic_user, species=self.cichlid)
        instance2 = SpeciesInstance.objects.create(name="Instance 2", user=self.active_user, species=self.cichlid)
    ...
    def test_species_comments_relationship(self):
        ...
        comment1 = SpeciesComment.objects.create(
            name="C1", user=self.basic_user, species=self.cichlid, comment="Great!"
        )
        comment2 = SpeciesComment.objects.create(
            name="C2", user=self.active_user, species=self.cichlid, comment="Nice!"
        )
    ...
    def test_club_members_relationship(self):
        ...
        member1 = AquaristClubMember.objects.create(name="Member 1", club=self.basic_club, user=self.basic_user)
        member2 = AquaristClubMember.objects.create(name="Member 2", club=self.basic_club, user=self.active_user)
